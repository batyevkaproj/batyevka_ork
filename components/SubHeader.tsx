...
const SubHeader = () => {
    ...
    <div className="h-full w-4/6 max-[1650px]:w-3/4 flex items-center justify-end">
        ...
        <div className="bg-none px-[50px] hover:text-[#DC662D]">
            <Link href='https://www.batyevka.net/uk/promotions' className={`inline-flex font-semibold  text-[16px] min-[2430px]:text-[21px] min-[2430px]:leading-[28px] text-center `}>Акції</Link>
        </div>
    </div>
    );
};
