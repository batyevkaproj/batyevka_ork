        ...
        <footer className={`bg-[#0E2D43] shadow-[0_4px_29px_0_rgba(8,35,27)]`}>
            ...
            <AccordionItem value="item-1">
                <AccordionTrigger className="h-[48px] flex items-center w-full">
                    <h3 className={`border-b border-[#56AABF] border-solid w-full text-white font-medium pb-[11px] mb-[8px] text-left`}>Ми надаємо послуги:</h3>
                </AccordionTrigger>
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger className="h-[48px] flex items-center w-full">
                    <h3 className={`border-b border-[#56AABF] border-solid w-full text-white font-medium pb-[11px] mb-[8px] text-left`}>ТАРИФИ</h3>
                </AccordionTrigger>
                <AccordionContent className="flex flex-col ml-[20px] text-white">
                    <Link href={'#'}>
                        Інтернет
            ...
            <AccordionItem value="item-3">
                <AccordionTrigger className="h-[48px] flex items-center w-full">
                    <h3 className={` w-full text-white font-medium pb-[11px] mb-[8px] text-left`}>Інформація абонентам</h3>
            ...
            <AccordionItem value="item-4">
                <AccordionTrigger className="h-[48px] flex items-center w-full">
                    <h3 className={`border-b border-[#56AABF] border-solid w-full text-white font-medium pb-[11px] mb-[8px] text-left`}>Технічна підтримка</h3>
                </AccordionTrigger>
                <AccordionContent className="flex flex-col ml-[20px] text-white">
                    <Link href={'#'}>
                        Акції
            ...
            <AccordionItem value="item-5">
                <AccordionTrigger className="h-[48px] flex items-center w-full">
                    <h3 className={`border-b border-[#56AABF] border-solid w-full text-white font-medium pb-[11px] mb-[8px] text-left`}>Контакти</h3>
                </AccordionTrigger>
                <AccordionContent className="flex flex-col ml-[20px] text-white">
                    <Link href={'#'}>
                        Акції
            ...
            <AccordionItem value="item-6">
                <AccordionTrigger className="h-[48px] flex items-center w-full">
                    <h3 className={`border-b border-[#56AABF] border-solid w-full text-white font-medium pb-[11px] mb-[8px] text-left`}>Соціальні мережі</h3>
                </AccordionTrigger>
                <AccordionContent className="flex flex-col ml-[20px] text-white">
                    <Link href={'#'}>
                        Акції
