        ...
        <div className={`grid text-white grid-cols-3 max-[1770px]:grid-cols-2 max-[1180px]:grid-cols-1 justify-center items-center max-[780px]:gap-5 place-items-center`}>
            <div className={`flex items-center justify-center h-[251px] max-[780px]:flex-col max-[780px]:h-[270px] min-[2430px]:h-[329px] min-[2430px]:w-[706px]`}>
                ...
                <div className={`flex flex-col w-[279px] max-[1180px]:w-[630px] ml-[42px] max-[1045px]:w-[500px]`}>
                    ...
                    <h3 className={` text-[24px] mt-10 max-[780px]:mt-1 max-[780px]:text-[16px] min-[2430px]:text-[32px] font-bold`}>Підключаємо за добу</h3>
                    <p className={` font-normal h-[126px] flex items-center leading-[24px] max-[780px]:h-full max-[780px]:text-[14px] min-[2430px]:text-[20px] min-[2430px]:w-[365px]`}>Підключаємо наступного дня, після подання заявки без попереднього укладання документів.</p>
                </div>
            </div>
            <div className={`flex items-center justify-center h-[251px] max-[780px]:flex-col min-[2430px]:h-[329px] min-[2430px]:w-[706px]`}>
