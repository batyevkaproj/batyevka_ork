...
const Advantages = () => {
    return (
        ...
        <div className={`grid text-white grid-cols-3 max-[1770px]:grid-cols-2 max-[1180px]:grid-cols-1 max-[780px]:gap-5 min-[3644px]:px-[240px] px-[170px] max-[2430px]:px-[120px] max-[1600px]:px-[85px] max-[1247px]:px-[67px] max-[932px]:px-[35px] max-[558px]:px-[20px] gap-x-[51px] min-[3644px]:gap-x-[90px] max-[2430px]:gap-x-[32px] gap-y-[40px] min-[3644px]:gap-y-[60px] max-[2430px]:gap-y-[30px] max-[780px]:gap-y-[20px]`}>
            <div className={`flex items-center h-[251px] max-[780px]:flex-col max-[780px]:h-[270px] min-[2430px]:h-[329px] min-[2430px]:w-[706px] max-[910px]:h-full`}>
            ...
            <div className={`flex items-center h-[251px] max-[780px]:flex-col min-[2430px]:h-[329px] min-[2430px]:w-[706px] max-[910px]:h-full max-[1180px]:flex-row-reverse`}>
                <Image src={docks} alt={``} className='min-[2430px]:h-[238px] min-[2430px]:w-[284px]'/>
                <div className={`flex flex-col max-[1180px]:items-end max-[780px]:items-start max-[1180px]:mr-[43px] min-[3644px]:ml-[80px] ml-[57px] max-[2377px]:ml-[43px] `}>
                    <span className={`relative -z-1 w-[43px] h-[3px] left-14 top-14 bg-white max-[780px]:hidden`}></span>
            ...
            <div className={`flex items-center h-[251px] max-[780px]:flex-col min-[2430px]:h-[329px] min-[2430px]:w-[706px] max-[910px]:h-full`}>
