...
const Advantages = () => {
    return ( 
        <div className={`grid text-white grid-cols-3 max-[1770px]:grid-cols-2 max-[1180px]:grid-cols-1 justify-center items-center max-[780px]:gap-5 place-items-center max-[2430px]:px-[120px] max-[590px]:pt-[40px] max-[590px]:gap-y-[20px]`}>
