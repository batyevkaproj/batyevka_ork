...
const Tarifs = () => {
    ...
    return (
        <>  {/* GPON biggest*/}
            ...
            {/*XG-GPON middle */}
            <div className="min-[1248px]:hidden max-[558px]:hidden pt-[40px]">
            ...
            {/* */}
            <div className={'max-[558px]:hidden mr-[170px] ml-[170px] max-[2377px]:mr-[120px] max-[2377px]:ml-[120px] max-[1600px]:mr-[85px] max-[1600px]:ml-[85px] max-[1247px]:mr-[67px] max-[1247px]:ml-[67px] max-[932px]:mr-[35px] max-[932px]:ml-[35px] min-[3644px]:mr-[240px] min-[3644px]:ml-[240px] min-[3644px]:pt-[180px] pt-[120px] max-[2377px]:pt-[90px] max-[1247px]:pt-[42px] max-[932px]:pt-[12px]'}>
