    ...
    return (
        ...
        <div className="flex justify-between items-center h-[70px] my-[30px] max-[720px]:h-[50px] max-[720px]:my-0">
            ...
            <nav className="mr-[50px] max-[720px]:mr-[20px] flex items-center">
                ...
                <button className="bg-[#DC662D] text-white rounded-full h-[60px] w-[270px] cursor-pointer font-['Montserrat'] font-semibold shadow-[0_4px_20px_0_#DC662D80] max-[779px]:hidden">
        ...
        <div className="h-20 flex justify-around items-center rounded-full bg-[#123853] shadow-lg mx-8 flex items-center justify-between max-[720px]:hidden">
            <Link href='#'  className="max-[1420px]:hidden text-white font-semibold font-['Montserrat'] text-[13px]">Для багатоповерхівок</Link>
            <Link href='#'  className="max-[1420px]:hidden text-white font-semibold font-['Montserrat'] text-[13px]">Приватним будинкам</Link>
            <Link href='#'  className="max-[1420px]:m-1 text-white font-semibold font-['Montserrat'] text-[13px] ">Для бізнеса</Link>
            <Image src={rectangle} alt='rect'/>
            <Link href='#'  className="text-white font-semibold font-['Montserrat'] text-[13px]">Доступ  в Інтернет</Link>
            <Link href='#'  className="max-[801px]:hidden text-white font-semibold font-['Montserrat'] text-[13px]">Трансляції ТБ і футбола для закладів</Link>
            <Link href='#'  className="max-[1024px]:hidden text-white font-semibold font-['Montserrat'] text-[13px]">Будівництво локальних мереж для офісів</Link>
            <Link href='#'  className="max-[1420px]:hidden text-white font-semibold font-['Montserrat'] text-[13px]">Відео нагляд <br/> для бізнеса</Link>
            <Link href='#'  className="text-white inline-flex font-semibold font-['Montserrat'] text-[13px]">Всі послуги <Image src={all_services} className="ml-2" alt='All Services'/></Link>
        </div>
