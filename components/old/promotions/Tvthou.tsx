    ...
    <div className="min-h-screen bg-white text-promo-gray-text">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-[55%] xl:w-1/2 lg:pr-[40px] text-center lg:text-left">
            ...
            <p className="text-[16px] font-semibold text-gray-800 mb-[15px] text=[#5f6061]">
              Підключайся і користуйся тарифом 1Гігабіт за  125 грн/міс протягом 12 місяців
            </p>
      ...
      <section className="py-12 lg:py-16 px-[15px] sm:px-[25px] lg:px-[50px] relative">
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid sm:grid-cols-2 mr-[400px] max-xl:mr-0">
            <div className="p-[40px] text-right relative max-w-[400px] justify-self-end">
            ...
            <div className="bg-white shadow-xl rounded-lg max-w-4xl mx-auto w-[746px] max-xl:w-[445px] p-[60px]">
              <div className="">
                <h3 className="text-[30px] font-bold mb-[20px] text-[#5f6061]">
                  Суть акції
                </h3>
                <p className="leading-relaxed mb-[25px] text-[16px]">
                  Нові та колишні абоненти, учасники Акції, які підключаються, обирають тарифний план «1Гігабіт» та мають технічну можливість підключення до Мережі Batyevka.NET на відповідній швидкості - отримують акційну абонентну плату на тарифі «1Гігабіт» 125 грн/міс протягом 12 місяців.
                </p>
