...
const BatyevkaLandingPage: React.FC = () => {
    ...
    // Стани для відстеження обраного тарифу та підписки
    const [selectedTariff, setSelectedTariff] = useState<number | null>(3); // 3-й тариф виділений за замовчуванням
            ...
            <div className="bg-white text-[#5F6061] min-h-screen" style={{ fontFamily: "'Inter', sans-serif" }}>
                <main className="container mx-auto px-4 py-8 md:py-16">
                    ...
                    <section className="py-12">
                        <div className="bg-gray-100 rounded-lg p-8 text-center">
                            ...
                            <div className="flex justify-center max-w-4xl mx-auto mb-8">
                                <div className="bg-white p-6 rounded-lg shadow-md border flex flex-col w-full max-w-sm">
                                    <h3 className="text-2xl font-bold text-[#5F6061]">10 Гбіт/с</h3>
                                    <p className="text-2xl font-bold text-[#DC662D] mt-2">2000<span className="text-lg font-normal"> грн/міс</span></p>
                    ...
                    <section id="megogo-section" className="py-12">
                         ...
                         <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 text-center">
                            
                            {megogoPlansData.map((plan, index) => {
                                // Отримуємо індекс пакету, що входить в поточний тариф
                                const includedLevel = getIncludedMegogoLevel(selectedTariff);
                                
                                // Якщо поточний пакет менше або дорівнює включеному - він вже в тарифі
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <article className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 border border-gray-200/80">
                        ...
                        />
                        <div className="p-6">
                            <p className="text-sm text-gray-500 mb-2">14 травня 2026</p>
                            <h3 className="text-xl font-bold mb-3 text-[#5F6061]">
                                Планові роботи з модернізації мережі
                            </h3>
                            <p className="text-gray-600 mb-4">
                                Для впровадження нових покращень на магістральному обладнанні та забезпечення найвищої якості зв'язку, ми проведемо короткі технічні роботи. Цього четверга з 05:00 до 06:00 ранку  
                            </p>
                        </div>
                    </article>
